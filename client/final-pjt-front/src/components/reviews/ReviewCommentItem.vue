<template>
  <div class="mx-5">
    <div v-if="!is_update" class="d-flex justify-content-between">
      <div>
        {{content}}
      </div>
      <div>
    ...
    <md-card-header style="background-color: white; color: white;">
      <form @submit.prevent="commentUpdate" v-if="is_update" class="d-flex justify-content-between">
        <md-field style="width:80%; margin-left: auto; margin-right: auto;">
          ...
          <button type="submit" id="submit" class="btn btn-dark"  @click="isUpdate">Submit</button>
        </md-field>
      </form>
    </md-card-header>
    <!-- <form @submit.prevent="commentUpdate" v-if="is_update" class="d-flex justify-content-between">
